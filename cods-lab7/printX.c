...
/***** Condicao logica da aplicacao: a thread B so podera imprimir a sentenca X=... quando x for multiplo de 10,
 e devera fazer isso uma unica vez e depois terminar sua execucao  ****/
